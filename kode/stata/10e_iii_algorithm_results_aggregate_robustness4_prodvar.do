...
scatter annual_bias_percent_1984prices ref_yr || scatter annual_bias_percent ref_yr , msymbol(T) xtitle("Year") ytitle("Annual Bias in Real Consumption Growth, %")  graphregion(color(white)) xlabel(2004(1)2014) legend(order(1 "2004 base prices" 2 " 2014 base prices") rows(1)) ylabel(-8(1)8)
