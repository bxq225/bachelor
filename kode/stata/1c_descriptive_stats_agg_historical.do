...
collapse (sum)  expn_t, by(ref_yr kategori a gns_pris_indeks inflation_t_tminus1 inflation_t_tplus1)
...
* Figure 2c
scatter laspeyres_price_index_final ref_y, xtitle("Year") ytitle("Geometric Index (1955=100)") graphregion(color(white)) xlabel(2007(2)2022) ylabel(100(150)850)
graph export "$resrootfig/Fig2c_indkomst.pdf", as(pdf) replace 
