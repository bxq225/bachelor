...
* fig E2ii
twoway connected p_naive indkomstgruppe if ref_yr_o==2003 || connected p_full indkomstgruppe if ref_yr_o==2003, xtitle("Pre-tax Income Percentile") ytitle("Geometric Index in 2003 (2022=100)")  graphregion(color(white)) xlabel(1(1)5) ///
...
* fig 4Bii
scatter pc_dev_real_cons indkomstgruppe if ref_yr_o==2003 || lfit pc_dev_real_cons indkomstgruppe if ref_yr_o==2003, xtitle("indkomstgruppe") ytitle("Bias in 2003 Real Consumption Level, %")  graphregion(color(white)) xlabel(1(1)5) legend(off)
