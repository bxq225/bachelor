*************************************************************
**** 8c. NH Correction: impact on aggregate real consumption 
*************************************************************

* i) with 1984 as base
use "$resrootdata/nh_percentiles_robustness2.dta", clear
foreach i in y qu q {
	replace `i'=exp(`i')
}
...
* ii) results 
use "$resrootdata/nh_percentiles_reverse_robustness2.dta", clear
...
graph export "$resrootfig/FigE11a.pdf", as(pdf) replace
...
graph export "$resrootfig/FigE11b.pdf", as(pdf) replace
