*************************************************************
**** 13c. NH Correction: impact on aggregate real consumption 
*************************************************************

* i) with 1984 as base
use "$resrootdata/nh_percentiles_RCF.dta", clear
foreach i in y qu q {
	replace `i'=exp(`i')
}
...
* ii) results 
use "$resrootdata/nh_percentiles_reverse_RCF.dta", clear
...
rename pc_dev_real_cons_1984 pc_dev_real_cons_1984_RCF
rename pc_dev_real_cons pc_dev_real_cons_RCF 
