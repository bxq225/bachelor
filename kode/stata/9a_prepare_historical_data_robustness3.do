*** 9a. 1/ study aggregate trends in this sample & define the "real adjustment factor" (using personal consumption expenditure)
clear
import delimited "$datarootrobustness/Yr_UCC_IncPercentile_BLSTableAdj_CPIRelImptAdj_EqlExpnShrIncrem_1955_2020.csv"
...
drop if l2=="Education"
drop if l2=="Personal insurance and pensions" 
...
gen double expn_normalized = tot_expn/19628.336*100
...
replace real_expn_`i' = 47.232209 if ref_yr==1955
}
...
save "$dataroot/cex_micro_1955_2019_final_robustness3.dta", replace
* note that here the adjustment for consumption uses the Geom laspeyres index


*** 3/ report patterns of cumulative growth with standard indices

use "$dataroot/cex_micro_1955_2019_final_robustness3.dta", clear
...
replace tot_expn=tot_expn/262868.71
...
drop if ref>2019
scatter cum_laspeyres_t_tp1 ref_y || scatter cum_fisher_t_tp1 ref_y || scatter cum_paasche_t_tp1 ref_y || scatter cum_geom_laspeyres ref_y
