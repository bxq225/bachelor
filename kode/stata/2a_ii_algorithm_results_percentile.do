...
graph export "$resrootfig/FigE2i_alder.pdf_2008", as(pdf) replace
...
graph export "$resrootfig/Fig4Ai_alder_2008.pdf", as(pdf) replace
...
graph export "$resrootfig/Fig4Bi_alder_2008.pdf", as(pdf) replace
...
graph export "$resrootfig/FigE3i_alder_2008.pdf", as(pdf) replace
