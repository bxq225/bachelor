...
****************************************************************
**** 15b. NH Correction: run algorithm with final period as base
****************************************************************
...
* note: the new controls compared with 4a_i are: 
* ref_sex_female_pct cutenure_rented_pct cutenure_owned_w_mortgage owned_vehq_zero_pct owned_vehq_one_ot_three_pct region_midwest_pct region_northeast_pct region_south_pct region_west_pct popsize_lt01mil_pct popsize_btwn01and05mil_pct 

* regress price index on real income at household level
reg p Lq1 Lq2 avg_age_adult_p* ref_sex_female_pct popsize_lt01mil_pct popsize_btwn01and05mil_pct  bls_urbn_rural_pct state* pct_asian_or_pacific_islander pct_black pct_multi_race_or_other pct_native_american pct_white pct_bachelor_s_degree pct_high_school_graduate if ref_yr==1985, r
* save coefficients
matrix b_t2 = e(b)
...
foreach t of numlist 1986(1)2019 {
	...
	* regress price index on real income at household level
	reg p Lq1 Lq2 avg_age_adult_p* ref_sex_female_pct popsize_lt01mil_pct popsize_btwn01and05mil_pct  bls_urbn_rural_pct state* pct_asian_or_pacific_islander pct_black pct_multi_race_or_other pct_native_american pct_white pct_bachelor_s_degree pct_high_school_graduate if ref_yr==`t', r
	* save coefficients
	matrix b_t2 = e(b)
...
* xi) save file 
save "$resrootdata/nh_percentiles_reverse_fullstatecontrols.dta", replace
