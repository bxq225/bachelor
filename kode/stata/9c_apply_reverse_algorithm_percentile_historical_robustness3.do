...
**************************************************************************
**** 9c NH Correction: run algorithm with final period as base, back to 1955
**************************************************************************
...
replace ref_yr = 1955+(2019-ref_yr)
...
foreach t of numlist 1957(1)2019 {
...
* xi) save file 
save "$resrootdata/nh_percentiles_reverse_1955_2019_robustness3.dta", replace
