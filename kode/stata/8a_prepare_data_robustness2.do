...
clear
import delimited "$datarootrobustness/RobustnessDataset2.csv"
...
drop if cpi_item_desc_recon_final=="College tuition and fees"
drop if cpi_item_desc_recon_final=="Elementary and high school tuition and fees" 

* we rename the category name so that we can use the same code as previously 
rename cpi_item_desc_recon_final ucc_str
...
gen double expn_normalized = tot_expn/19515.942*100
...
save "$dataroot/cex_micro_1984_2019_robustness2.dta", replace
