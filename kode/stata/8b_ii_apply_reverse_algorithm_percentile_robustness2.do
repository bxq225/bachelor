...
****************************************************************
**** 8b ii. NH Correction: run algorithm with final period as base
****************************************************************

* i) load data and collapse by year-category & percentile
use "$dataroot/cex_micro_1984_2019_robustness2.dta", clear
...
* xi) save file 
save "$resrootdata/nh_percentiles_reverse_robustness2.dta", replace
