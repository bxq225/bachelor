...
*******************************************************
**** 3a. NH Correction: run algorithm from 1955 onward 
*******************************************************
...
* Fig E1iv
binscatter p y if ref_yr<1984, nq(100) absorb(ref_yr) xtitle("Log nominal consumption") ytitle("Log Geometric index (annual)")
graph export "$resrootfig/FigE1iv.pdf", as(pdf) replace 
...
save "$resrootdata/nh_percentiles_1955_2019.dta", replace
