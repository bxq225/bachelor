...
rename decile inc 
gen double annual_gross_infl_tplus1_t = 1+inflation_ces_prodvar/100
...
save "$dataroot/adjustment_factor_realPCE_geomlasp_nielsen_prodvar", replace
...
merge m:1 ref_yr using "$dataroot/adjustment_factor_realPCE_geomlasp_nielsen_prodvar"
...
save "$dataroot/cex_micro_1984_2019_robustness4_prodvar.dta", replace
