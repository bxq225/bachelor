...
****************************************************************
**** 4a ii. NH Correction: run algorithm with final period as base
****************************************************************
...
keep ref_yr tot_expn laspeyres_t_tp1 husstand ref_yr_original
duplicates drop
...
* xi) save file 
save "$resrootdata/nh_percentiles_reverse_controls.dta", replace
