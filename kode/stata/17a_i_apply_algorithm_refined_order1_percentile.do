***************************************
**** 17a. NH Correction: run algorithm 
***************************************
...
tsset inc_percentile ref_yr
	...
	* get real consumption at time t without NH correction
	replace qu  = Lqu + (y-Ly-p_lasp)  if ref_yr==1985
