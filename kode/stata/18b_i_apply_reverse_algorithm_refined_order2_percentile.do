***************************************
**** 18b. NH Correction: run algorithm 
***************************************


* 0) Prepare values from baseline first-order algorithm as guesses 
use "$resrootdata/nh_percentiles_refined_order1_reverse.dta", clear
...
* xi) save file 
save "$resrootdata/nh_percentiles_refined_order2_reverse.dta", replace
