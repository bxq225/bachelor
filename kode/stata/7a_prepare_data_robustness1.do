...
clear
import delimited "$datarootrobustness/RobustnessDataset1.csv"
...
rename l3_l2_mix_title_use ucc_str
...
save "$dataroot/cex_micro_1984_2019_robustness1.dta", replace
