...
* Figure 2a
scatter laspeyres_price_index_final ref_y, xtitle("") ytitle("Geometrisk Indeks (2007=100)") graphregion(color(white)) xlabel(2007(2)2022) ylabel(100(2)144)
graph export "$resrootfig/Fig2a_region.pdf", as(pdf) replace 
