...
**************************************************
**** 5c i. NH correction: run second-order algorithm
**************************************************
...
sort indkomstgruppe ref
order ref indkomstgruppe y Ly q Lq baseline_q Lam LamLq Lam_old
...
* save file 
save "$resrootdata/nh_percentiles_2nd_order_fisher.dta", replace
